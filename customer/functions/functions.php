<?php
$db=mysqli_connect("localhost:3307","root","","ct271");
...
function addCart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows( $run_check)>0){
            echo "
            <script>alert('Sản phẩm này đã được thêm vào giỏ hàng')</script>
            ";
            echo "
                ...
                <div class='product'>
                    ...
                    <div class='text'>
                        ...
                        <p class='buttons'>
                            ...
                            <a href='details.php?pro_id=$pro_id' class='btn btn-primary'><i class='fa fa-shopping-cart'></i> Thêm vào giỏ</a>
                        </p>
                    </div>
                </div>
        </div>";
...
function getPcatPro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        if($count==0){
            echo "
            <div class='box'>
                <h1>Không tìm thấy sản phẩm trong danh mục sản phẩm này</h1>
            </div>
            ";
        }else{
            echo "
...
function getCatPro(){
    ...
    if(isset($_GET['cat_id'])){
        ...
        if($count==0){
            echo "
            <div class='box'>
                <h1>Không tìm thấy sản phẩm thuộc phân loại này</h1>
            </div>
            ";
        }else{
            echo "
